...
type ConsulUpstream struct {
	...
	MeshGateway NullableConsulMeshGateway `json:"MeshGateway,omitempty"`
}
...
// GetMeshGateway returns the MeshGateway field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ConsulUpstream) GetMeshGateway() ConsulMeshGateway {
	if o == nil || o.MeshGateway.Get() == nil {
		var ret ConsulMeshGateway
		return ret
	}
	return *o.MeshGateway.Get()
}
...
// SetMeshGateway gets a reference to the given NullableConsulMeshGateway and assigns it to the MeshGateway field.
...
func (o *ConsulUpstream) SetMeshGatewayNil() {
	o.MeshGateway.Set(nil)
}
...
func (o ConsulUpstream) MarshalJSON() ([]byte, error) {
	...
	if o.MeshGateway.IsSet() {
		toSerialize["MeshGateway"] = o.MeshGateway.Get()
	}
